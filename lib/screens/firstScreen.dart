...
import 'package:product_ms/controller/alertController.dart';
import 'package:product_ms/controller/initPrinter.dart';
import 'package:product_ms/controller/urlController.dart';
import 'package:product_ms/main.dart';
import 'package:product_ms/screens/homescreen.dart';
import 'package:product_ms/screens/profile.dart';
                          ...
                          child: OutlinedButton.icon(
                            style: OutlinedButton.styleFrom(
                                 primary: const Color(0xffCC471B),
                                  side: const BorderSide(width: 1.0, color: Color(0xffCC471B)),
                            ),
                              onPressed: () {
                          ...
                          InkWell(
                            ...
                            child: Material(
                              ...
                              color: urlController.getUrlValue == 1
                                  ? const Color(0xffCC471B).withOpacity(0.9)
                                  : Colors.white,
                              elevation: 10.0,
                              child:  SizedBox(
                                height: 100,
                                ...
                                style: TextStyle(color:  urlController.getUrlValue == 1
                                  ?  Colors.white
                                  : Colors.black, ),
                                ),
